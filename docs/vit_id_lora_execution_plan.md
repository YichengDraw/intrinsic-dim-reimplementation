...
> This document describes the ViT transfer-learning extension that is included in this repository.
> Use it when you want the modern ViT + LoRA + intrinsic-dimension comparison, not just the classic ICLR 2018 experiments.
...
1. Upload this repository to a cloud workspace or remote machine.
